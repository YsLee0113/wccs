    ...
    <div>
        <div class="container">
            ...
            <el-table :data="tableData" size="mini" border class="table" ref="multipleTable"   header-cell-class-name="table-header">
                            <el-table-column prop="wid" label="任务编号"></el-table-column>
                <el-table-column prop="wname" label="任务名称"></el-table-column>
                <el-table-column prop="wcontent" label="任务内容"></el-table-column>
                <el-table-column prop="wuser" label="发布教师"></el-table-column>
                <el-table-column prop="waddtime" label="发布时间"></el-table-column>
        ...
        <el-dialog title="添加" v-model="addVisible" width="30%">
            <el-form  size="small"  label-width="100px">
                    <el-form-item label="任务名称:">
                        <el-input placeholder="请输入任务名称" v-model="form.wname">
                        </el-input>
                    </el-form-item>
                    <el-form-item label="任务内容:">
                        <el-input placeholder="请输入任务内容" v-model="form.wcontent">
                        </el-input>
                    </el-form-item>
                    <el-form-item label="发布教师:">
                        <el-input placeholder="请输入发布教师" v-model="form.wuser">
                        </el-input>
                    </el-form-item>
                    <el-form-item label="发布时间:">
                        <el-input placeholder="请输入发布时间" v-model="form.waddtime">
                        </el-input>
                    </el-form-item>
            </el-form>
            <template #footer>
        ...
        <el-dialog title="编辑" v-model="editVisible" width="30%">
            <el-form size="small" label-width="100px">
                        <el-form-item label="任务编号:">
                            <el-input placeholder="请输入任务编号"  :disabled="true" v-model="form.wid">
                            </el-input>
                        </el-form-item>
                        <el-form-item label="任务名称:">
                            <el-input placeholder="请输入任务名称" v-model="form.wname">
