    ...
    <div>
        <div class="container">
            ...
            <el-table :data="tableData" size="mini" border class="table" ref="multipleTable"
                ...
                <el-table-column label="路径(查看大图)" align="center">
                    <template #default="scope">
                       <a :href="scope.row.picurl" class="btn btn-danger">下载</a>
                    </template>
                </el-table-column>
        ...
        <el-dialog title="添加" v-model="addVisible" width="45%">
            <el-form size="small" label-width="100px">
                ...
                <el-form-item label="路径:">
                    <el-input placeholder="请输入路径" style="width: 80%;display: inline-block;" v-model="form.picurl">
                    </el-input>
                ...
                <el-form-item label="介绍:">
                    <el-input placeholder="请输入介绍" v-model="form.intro">
                    </el-input>
                </el-form-item>
            </el-form>
            <template #footer>
    ...
    export default {
        ...
        setup() {
            ...
            const getData = () => {
                ...
                var sql = " select * from filesinfo  ";
                if (keyword != '') {
                    pageNum = 1;
                    sql = "select * from filesinfo where name like '%" + keyword + "%'  ";
                }
            ...
            const handleDelete = (index, row) => {
                ...
                ElMessageBox.confirm("确定要删除吗？", "提示", {
                    ...
                    .then(() => {
                        //执行删除操作 接口请求
                        var deleteid = row.id;
                        var data = {"sql": "delete  from filesinfo where  id='" + deleteid + "' "}
                        request({
                            url: '/updateAction',
                            method: 'get',
                            params: data
            ...
            const saveInsert = () => {
                ...
                var data = {"sql": `insert into filesinfo (id,name,picurl,intro)  values ('${obj.id}','${obj.name}','${obj.picurl}','${obj.intro}')`}
                //执行删除操作 接口请求
                request({
                    url: '/updateAction',
                    method: 'get',
            ...
            const saveEdit = () => {
                ...
                var that = this;
                var obj = form;
                var data = {"sql": `  update filesinfo set name = '${obj.name}',picurl = '${obj.picurl}',intro = '${obj.intro}'  where id = '${obj.id}'  `}
                request({
                    url: '/updateAction',
                    method: 'get',
                    params: data
