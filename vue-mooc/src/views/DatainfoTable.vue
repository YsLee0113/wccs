	...
	<div>
		<div class="container">
			...
			<el-table :data="tableData" size="mini" border class="table" ref="multipleTable"
				...
				<el-table-column prop="dataid" label="编号"></el-table-column>
				<el-table-column prop="dataname" label="名称"></el-table-column>
				<el-table-column v-if="false" prop="datacontent" label="内容"></el-table-column>
				<el-table-column label="图片(查看大图)" align="center">
					<template #default="scope">
						<el-image class="table-td-thumb" :src="scope.row.dataintro"
							:preview-src-list="[scope.row.dataintro]">
						</el-image>
					</template>
				</el-table-column>
				<el-table-column prop="datauser" label="用户"></el-table-column>
				<el-table-column prop="dataurl" label="视频"></el-table-column>
				<el-table-column prop="dataremarker" label="备注"></el-table-column>
				<el-table-column prop="datatype" label="分类"></el-table-column>
				<el-table-column prop="dataaddtime" label="时间"></el-table-column>
		...
		<el-dialog title="添加" v-model="addVisible" width="30%">
			<el-form size="small" label-width="100px">
				<el-form-item label="名称:">
					<el-input placeholder="请输入名称" v-model="form.dataname">
					</el-input>
				</el-form-item>
				<el-form-item label="内容:">
					<el-input placeholder="请输入内容" v-model="form.datacontent">
					</el-input>
				</el-form-item>
				<el-form-item label="视频:">
					<el-input placeholder="请输入视频路径" v-model="form.dataurl">
					</el-input>
				</el-form-item>
				<el-form-item label="用户:">
					<el-input placeholder="请输入用户" v-model="form.datauser">
					</el-input>
				</el-form-item>
				<el-form-item label="图片:">
					<el-input placeholder="请输入图片" style="width: 80%;display: inline-block;" v-model="form.dataintro">
					</el-input>
				...
				<el-form-item label="备注:">
					<el-input placeholder="请输入备注" v-model="form.dataremarker">
					</el-input>
				</el-form-item>
				<el-form-item label="分类:">
					<el-input placeholder="请输入分类" v-model="form.datatype">
					</el-input>
				</el-form-item>
				<el-form-item label="时间:">
					<el-input placeholder="请输入时间" v-model="form.dataaddtime">
					</el-input>
				</el-form-item>
			</el-form>
			<template #footer>
		...
		<el-dialog title="编辑" v-model="editVisible" width="30%">
			<el-form size="small" label-width="100px">
				<el-form-item label="编号:">
					<el-input placeholder="请输入编号" :disabled="true" v-model="form.dataid">
					</el-input>
				</el-form-item>
				<el-form-item label="名称:">
					<el-input placeholder="请输入名称" v-model="form.dataname">
				...
				<el-form-item label="路径:">
					<el-input placeholder="请输入路径" v-model="form.dataurl">
					</el-input>
				</el-form-item>
				<el-form-item label="用户:">
					<el-input placeholder="请输入用户" v-model="form.datauser">
