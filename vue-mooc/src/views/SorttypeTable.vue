	...
	<div>
		<div class="container">
			...
			<el-table :data="tableData" size="mini" border class="table" ref="multipleTable"
				...
				<el-table-column prop="sid" label="分类编号"></el-table-column>
				<el-table-column prop="sname" label="分类名称"></el-table-column>
				<el-table-column prop="scontent" label="分类内容"></el-table-column>
				<el-table-column prop="sremarker" label="分类备注"></el-table-column>
		...
		<el-dialog title="添加" v-model="addVisible" width="30%">
			<el-form size="small" label-width="100px">
				<el-form-item label="分类名称:">
					<el-input placeholder="请输入分类名称" v-model="form.sname">
					</el-input>
				</el-form-item>
				<el-form-item label="分类内容:">
					<el-input placeholder="请输入分类内容" v-model="form.scontent">
					</el-input>
				</el-form-item>
				<el-form-item label="分类备注:">
					<el-input placeholder="请输入分类备注" v-model="form.sremarker">
					</el-input>
				</el-form-item>
			</el-form>
			<template #footer>
		...
		<el-dialog title="编辑" v-model="editVisible" width="30%">
			<el-form size="small" label-width="100px">
				<el-form-item label="分类编号:">
					<el-input placeholder="请输入分类编号" :disabled="true" v-model="form.sid">
					</el-input>
				</el-form-item>
				<el-form-item label="分类名称:">
					<el-input placeholder="请输入分类名称" v-model="form.sname">
