        ...
        <el-dialog title="添加" v-model="addVisible" width="30%">
            <el-form  size="small"  label-width="100px">
                    ...
                    <el-form-item label="结果:">
                        <el-input placeholder="请输入结果" v-model="form.result">
                        </el-input>
                    </el-form-item>
                    <el-form-item label="分数:">
                        <el-input placeholder="请输入分数" v-model="form.score">
                        </el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="时间:">
                        <el-input placeholder="请输入时间" v-model="form.createtime">
                        </el-input>
                    </el-form-item>
            </el-form>
            <template #footer>
